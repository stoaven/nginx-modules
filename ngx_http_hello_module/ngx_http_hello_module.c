...
static void *ngx_http_hello_create_loc_conf(ngx_conf_t *cf)
{
    ngx_http_hello_loc_conf_t* hlcf = NULL;
    ...
    ngx_str_null(&hlcf->hello_string);
    hlcf->hello_counter = NGX_CONF_UNSET;
...
ngx_http_hello_string(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
	...
	ngx_conf_log_error(NGX_LOG_EMERG, cf, 0, "hello_string:%s", hlcf->hello_string.data);
        ...
        void *conf)
{
    ...
    ngx_conf_log_error(NGX_LOG_EMERG, cf, 0, "hello_counter:%d", hlcf->hello_counter);
